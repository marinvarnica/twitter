<template>
    <li class="w-3/12">
        <a href="#" class="flex items-center text-base" @click.prevent="likeOrUnlike">
            ...
            >
                <path  d="M12.76 3.76a6 6 0 0 1 8.48 8.48l-8.53 8.54a1 1 0 0 1-1.42 0l-8.53-8.54a6
                        6 0 0 1 8.48-8.48l.76.75.76-.75zm7.07 7.07a4 4 0 1 0-5.66-5.66l-1.46 1.47a1 1 0 0 1-1.42
